...
var _chartJs = require("./js/chart.js");
var _gameJs = require("./js/game.js");

},{"./js/chart.js":"hCAGV","./js/game.js":"gnxQg"}],"hCAGV":[function(require,module,exports,__globalThis) {
...
document.addEventListener('keydown', (event)=>{
    ...
    if (pressed === keys[currentKeyIndex]) {
        currentKeyIndex++;
        if (currentKeyIndex < keys.length) updateKeyDisplay();
        else {
            alert({
                text: 'YOU WIN!',
                delay: 2100
...
},{}]},["5j6Kf","a0t4e"], "a0t4e", "parcelRequire58d1", {})

//# sourceMappingURL=pnotify.31b563d9.js.map
